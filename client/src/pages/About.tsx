    ...
    <div className="container mx-auto px-4 py-16 sm:py-20 md:py-24 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
        ...
        >
          ...
          <div className="flex gap-4">
            <a href="https://github.com/FelixAshong" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-colors">
            ...
            <a href="https://www.linkedin.com/in/felix-ashong/" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-colors">
              <svg className="w-5 h-5 sm:w-6 sm:h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect width="4" height="12" x="2" y="9"></rect><circle cx="4" cy="4" r="2"></circle></svg>
            </a>
            <a href="https://x.com/phleodelly" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-colors">
              <svg className="w-5 h-5 sm:w-6 sm:h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg>
            </a>
            <a href="https://www.instagram.com/phleodelly/" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-colors">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          <div className="bg-card/50 p-4 sm:p-6 rounded-lg">
            <h3 className="text-lg sm:text-xl font-bold text-foreground mb-2">Frontend Developer</h3>
            <p className="text-primary mb-2 text-sm sm:text-base">NAVANTRICS Ltd • 2023</p>
            <p className="text-muted-foreground text-sm">Actively participated in web application and development projects under senior I.T staff mentorship.Designed and implemented interactive user interfaces for websites and applications.</p>
          </div>
          
          <div className="bg-card/50 p-4 sm:p-6 rounded-lg">
            <h3 className="text-lg sm:text-xl font-bold text-foreground mb-2">Network Engineer</h3>
            <p className="text-primary mb-2 text-sm sm:text-base">UGCS • 2024</p>
            <p className="text-muted-foreground text-sm">Collaborated with IT professionals to identify system needs and implement solutions and also Configured and installed network hardware including routers, switches, and firewalls.</p>
          </div>
          
          <div className="bg-card/50 p-4 sm:p-6 rounded-lg">
            <h3 className="text-lg sm:text-xl font-bold text-foreground mb-2">Freelance Developer</h3>
            <p className="text-primary mb-2 text-sm sm:text-base">Self-employed • 2022 - present</p>
