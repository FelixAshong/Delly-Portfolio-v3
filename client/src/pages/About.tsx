  ...
  return (
    <div className="container mx-auto px-4 py-24 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-16">
        ...
        >
          <h2 className="text-3xl font-bold mb-6 text-foreground">Who am I?</h2>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between mb-1">
                  <h4 className="text-lg font-semibold text-foreground">BSc. Computer Science</h4>
              ...
              <div>
                <div className="flex justify-between mb-1">
                  <h4 className="text-lg font-semibold text-foreground">Senior Web Developer</h4>
      ...
      >
        <h2 className="text-3xl font-bold mb-6 text-foreground">My Values</h2>
      ...
      >
        <h2 className="text-3xl font-bold mb-6 text-foreground">Let's Work Together</h2>
